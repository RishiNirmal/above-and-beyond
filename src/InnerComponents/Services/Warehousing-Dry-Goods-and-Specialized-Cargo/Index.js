...
export default class WarehousingDryGoodsAndSpecializedCargo extends Component {
  render() {
    return (
      <>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  ...
                  <p>Storage can be the basic function of any warehouse, but we don’t stop there.</p>
                   <p> Many warehouses are not able to provide immediate storage to surplus Inventories. We are ready store your surplus inventories anytime and/or in case of emergencies.</p>
                    <p>Our expert warehouse management team takes care of your goods and safeguards them against any possible risk.</p>
